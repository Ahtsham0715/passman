    ...
    return Scaffold(
      ...
      body: Center(
        child: Column(
          ...
          children: <Widget>[
            Text('hasEnabledAutofillServices: $_hasEnabledAutofillServices\n',
                style: TextStyle(fontSize: 25.0)),
            Text(
                'metadata: ${_metadata == null ? 'none' : _metadata?.toJson().toString()}',
                style: TextStyle(fontSize: 25.0)),
            ElevatedButton(
              child: const Text('Request Autofill Service',
                  style: TextStyle(fontSize: 25.0)),
              onPressed: () async {
            ...
            ElevatedButton(
              child: const Text('finish', style: TextStyle(fontSize: 25.0)),
              onPressed: () async {
                print('Starting request.');
