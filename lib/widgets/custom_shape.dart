...
Path path_0 = Path();
    ...
    path_0.cubicTo(size.width*0.8892633,size.height*0.5911293,size.width*0.6985628,size.height*0.7034221,size.width*0.4818841,size.height*0.7034221);
    path_0.cubicTo(size.width*0.2872536,size.height*0.7034221,size.width*0.1135838,size.height*0.6128213,0,size.height*0.4711179);
